        ...
        <div id='nomecompleto' class='nomecompleto'>
            <div style = "left: 600px;"class="forms">
                <form action="cadastro.php" method="post" >
                        ...
                        <input type="text" name="nome" required maxlength="40" minlength="25">
                        <p></p>
                        <label>Email:</label>
                        <input type="text" name="email" required maxlength="50" minlength="30">
                        <p></p>
                        <label>CPF:</label>
                        <input type="number" name="cpf" required maxlength= "15" minlength="11">
                        <p></p>
                        <label>Telefone:</label>
                        <input type="number" name="telefone" required maxlength="12" minlength="11">
                        <p></p>
